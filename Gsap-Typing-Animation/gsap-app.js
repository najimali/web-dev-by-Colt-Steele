const words =['Najim Ali.',"A Web developer.","A Programmer.","A Brother."];
//Making the cursor repeating infinite time

let cursor = gsap.to('.cursor', {opacity:0, ease: "power2.inOut", repeat:-1})
let masterTl = gsap.timeline({repeat: -1}).pause()
let boxTl = gsap.timeline()

boxTl.to('.box', {duration:1, width:"22vw", delay: 0.5, ease: "power4.inOut"})
